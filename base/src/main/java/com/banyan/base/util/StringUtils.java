...
//        String fielPath = mContext.getApplicationContext().getPackageCodePath()+"file";
//        File storageDir = new File(fielPath);
    ...
    public static double getNumber(String turnoverYuan) {
        try{
            double v = Double.parseDouble(turnoverYuan);
            return v;
        }catch (Exception e){
